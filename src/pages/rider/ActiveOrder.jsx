...
import { MapPin, Phone, Navigation, ArrowLeft, Package, Truck, CheckCircle } from 'lucide-react';

const statusSteps = [
  { id: 'PICKED_UP',  label: 'Recogido',  icon: Package },
                ...
                <div key={step.id} className="flex flex-col items-center">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    idx === 1
                      ...
                      : 'bg-secondary-light text-muted border border-subtle'
                  }`}>
